...
shinyUI(fluidPage(
  # Application title
  titlePanel("CRAN-R Packages Download Stats"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      HTML("Created using the <a href='https://github.com/metacran/cranlogs'>cranlogs</a> package.",
           ...
           "Read more about it <a href='http://varianceexplained.org/r/cran-view/'>here</a>.")
      ,hr()
      ,img(src = "Rlogo.png", height = 60, width = 60)
      
    ),

    # Show a plot of the generated distribution
    mainPanel(
      HTML("See Trend for R packages Downloads"),
      plotOutput("downloadsPlot")
      ,hr()
      ,HTML("Year Growth Percentage of Downloaded Packages")
      ,plotOutput("growthdownloadsPlot")
      ,hr()
      ,HTML("Top R Packages Downloaded")
      ,plotOutput("topdownloadsPlot")
    )
  )
))
